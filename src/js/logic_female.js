...
function fetchData() {
  d3.queue()
    ...
    .defer(d3.json, "src/data/countries_female.json")
...
function drawMap(world, data) {
  ...
  var color = d3
    .scaleThreshold()
    .domain([
      5000, 50000, 250000, 500000, 2500000, 5000000, 25000000, 50000000,
      250000000, 750000000,
    ])
    .range([
      "#d7e1ee",
    ...
    .on("mouseover", function (d) {
      ...
      d3.select(".population").text(
        (d.details &&
          ...
          "Total Females: " + Number(d.details.population).toLocaleString()) ||
          "No Data"
      );
